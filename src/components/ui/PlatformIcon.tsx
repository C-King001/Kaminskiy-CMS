...
const ICON_MAP: Record<string, React.FC> = {
  instagram: IGIcon,
  instagram_feed: IGIcon,
  instagram_reel: IGIcon,
  instagram_story: IGIcon,
  facebook: FBIcon,
  facebook_post: FBIcon,
  facebook_reel: FBIcon,
  youtube_shorts: YTIcon,
  youtube_short: YTIcon,
  youtube_video: YTIcon,
  tiktok: TikTokIcon,
  website: GlobeIcon,
...
export function PlatformIcon({ platform, showLabel }: PlatformIconProps) {
  const Icon = ICON_MAP[platform] ?? GlobeIcon
